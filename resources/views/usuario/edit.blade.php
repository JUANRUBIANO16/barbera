                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <select name="tipo_usuario" id="tipo_usuario" class="form-control @error('tipo_usuario') is-invalid @enderror" required>
                            ...
                            <option value="administrador" {{ (old('tipo_usuario') ?? ($usuario->administrador ? 'administrador' : '')) == 'administrador' ? 'selected' : '' }}>Administrador</option>
                            <option value="barbero" {{ (old('tipo_usuario') ?? ($usuario->barbero ? 'barbero' : '')) == 'barbero' ? 'selected' : '' }}>Barbero</option>
                            <option value="cliente" {{ (old('tipo_usuario') ?? ($usuario->cliente ? 'cliente' : '')) == 'cliente' ? 'selected' : '' }}>Cliente</option>
                        </select>
                        @error('tipo_usuario')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                               value="{{ old('nombre', $usuario->cliente->nombre ?? $usuario->barbero->nombre ?? $usuario->administrador->nombre ?? '') }}" required>
                        @error('nombre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="apellido" id="apellido" class="form-control @error('apellido') is-invalid @enderror" 
                               value="{{ old('apellido', $usuario->cliente->apellido ?? $usuario->barbero->apellido ?? $usuario->administrador->apellido ?? '') }}" required>
                        @error('apellido')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="telefono" id="telefono" class="form-control @error('telefono') is-invalid @enderror" 
                               value="{{ old('telefono', $usuario->cliente->telefono ?? $usuario->barbero->telefono ?? $usuario->administrador->telefono ?? '') }}" required>
                        @error('telefono')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div id="administrador_fields" class="tipo_fields" style="display: none;">
                        <div class="col-md-6">
                            ...
                            <input type="email" name="correo_admin" id="correo_admin" class="form-control @error('correo_admin') is-invalid @enderror" 
                                   value="{{ old('correo_admin', $usuario->administrador->correo ?? '') }}">
                            @error('correo_admin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div id="barbero_fields" class="tipo_fields" style="display: none;">
                        <div class="col-md-6">
                            ...
                            <select name="disponibilidad" id="disponibilidad" class="form-control @error('disponibilidad') is-invalid @enderror">
                                ...
                                <option value="disponible" {{ (old('disponibilidad') ?? $usuario->barbero->disponibilidad ?? '') == 'disponible' ? 'selected' : '' }}>Disponible</option>
                                <option value="ocupado" {{ (old('disponibilidad') ?? $usuario->barbero->disponibilidad ?? '') == 'ocupado' ? 'selected' : '' }}>Ocupado</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="num_doc" id="num_doc" class="form-control @error('num_doc') is-invalid @enderror" 
                                   value="{{ old('num_doc', $usuario->barbero->num_doc ?? '') }}">
                            @error('num_doc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="salario" id="salario" class="form-control @error('salario') is-invalid @enderror" 
                                   value="{{ old('salario', $usuario->barbero->salario ?? '') }}">
                            @error('salario')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="edad" id="edad" class="form-control @error('edad') is-invalid @enderror" 
                                   value="{{ old('edad', $usuario->barbero->edad ?? '') }}" min="1" max="120">
                            @error('edad')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div id="cliente_fields" class="tipo_fields" style="display: none;">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="correo_cliente" id="correo_cliente" class="form-control @error('correo_cliente') is-invalid @enderror" 
                                   value="{{ old('correo_cliente', $usuario->cliente->correo ?? '') }}">
    ...
    function toggleFields() {
        ...
        switch(tipoUsuarioSelect.value) {
            case 'administrador':
                ...
                // Hacer contraseña opcional para edición
