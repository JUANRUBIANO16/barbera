...
@section('content')
<h1 class="mt-4 px-5">Crear Venta</h1>
...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <select name="id_serv" id="id_serv" class="form-control" required>
            ...
            @foreach($servicios as $servicio)
                <option value="{{ $servicio->id_serv }}" {{ old('id_serv') == $servicio->id_serv ? 'selected' : '' }}>
   ...
   <small class="text-danger">{{'*'.$message}}</small>
    ...
    <div class="col-md-6">
        ...
        <input type="number" name="valor" id="valor" class="form-control" value="{{old('valor')}}" required min="0">
    @error('valor')
   <small class="text-danger">{{'*'.$message}}</small>
    @enderror
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="number" name="cantidad" id="cantidad" class="form-control" value="{{old('cantidad', 1)}}" min="1">
    @error('cantidad')
   <small class="text-danger">{{'*'.$message}}</small>
    @enderror
    </div>
