...
@section('content')
<h1 class="mt-4 px-5">Crear Disponibilidad</h1>
<ol class="breadcrumb mb-4 px-5">
    ...
    <li class="breadcrumb-item active">Crear Disponibilidad</li>
</ol>
...
<div class="row g-3">
   ...
   <small class="text-danger">{{'*'.$message}}</small>
    ...
    <div class="col-md-6">
        ...
        <input type="time" name="hora_de_inicio" id="hora_de_inicio" class="form-control" value="{{old('hora_de_inicio')}}" required>
