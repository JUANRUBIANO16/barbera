                    ...
                    <div class="col-md-4">
                        ...
                        <select name="id_admin" id="id_admin" class="form-control @error('id_admin') is-invalid @enderror">
                            ...
                            @foreach($administradores as $admin)
                                <option value="{{ $admin->id_admin }}" {{ old('id_admin', $persona->id_admin) == $admin->id_admin ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="id_barbero" id="id_barbero" class="form-control @error('id_barbero') is-invalid @enderror">
                            ...
                            @foreach($barberos as $barbero)
                                <option value="{{ $barbero->id_barbero }}" {{ old('id_barbero', $persona->id_barbero) == $barbero->id_barbero ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="id_clie" id="id_clie" class="form-control @error('id_clie') is-invalid @enderror">
                            ...
                            @foreach($clientes as $cliente)
                                <option value="{{ $cliente->id_clie }}" {{ old('id_clie', $persona->id_clie) == $cliente->id_clie ? 'selected' : '' }}>
